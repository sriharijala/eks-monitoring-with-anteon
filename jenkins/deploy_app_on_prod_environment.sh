...
#replace s3 bucker name
AWS_REGION=$AWS_REGION helm repo add stable-petclinic s3://sjala-eks-monitoring-with-anteon-helm-charts/stable/myapp/ || echo "repository name already exists"
